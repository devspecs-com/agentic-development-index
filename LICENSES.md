...
Different repository paths have different reuse goals.

## Code

Source code, scripts, schemas, tests, and configuration are licensed under the repository [MIT License](LICENSE).
...
By contributing, you agree that your contribution is distributed under the license applicable to its destination path. Do not submit content or data you do not have permission to redistribute.
