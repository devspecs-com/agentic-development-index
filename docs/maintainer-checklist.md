...
The editable source is [`.github/social-preview.html`](../.github/social-preview.html); upload the rendered [`.github/social-preview.png`](../.github/social-preview.png) in the repository's social preview settings.
